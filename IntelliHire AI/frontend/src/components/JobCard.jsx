...
const JobCard = ({ job, isBestMatch }) => {
    ...
    return (
        <div className={`card group relative ${isBestMatch ? 'border-primary-500/50 bg-primary-900/10' : ''}`}>
            {isBestMatch && (
            ...
            <div className="flex justify-between items-start mb-4">
                <div>
                    <h3 className="text-xl font-bold group-hover:text-primary-400 transition-colors uppercase tracking-tight">
                        {job.title}
                    </h3>
                ...
                <div className="flex flex-col items-end">
                    {job.matchScore !== undefined ? (
                        ...
                        <span className="text-xs text-slate-500 font-bold uppercase tracking-wider">Score pending</span>
                    )}
                </div>
            </div>
